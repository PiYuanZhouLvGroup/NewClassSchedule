# Copied from https://github.com/xinetzone/tkinter_action/blob/master/app/tools/tips.py
...
class ToolTip:
    ...
    def __init__(self, widget, text=None, textvariable=None, timeout=300, offset=(0, -20), **kw):
        ...
        self.widget.bind("<Motion>", self.update_geo)
    ...
    def update_geo(self, event):  # Add by me
        self.x = event.x
        self.y = event.y
        new_x, new_y = self.wm_geometry()
        if self.tip_window:
